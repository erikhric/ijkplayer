...
#define DEFAULT_HIGH_WATER_MARK_IN_BYTES        (512 * 1024)
...
#define DEFAULT_NEXT_HIGH_WATER_MARK_IN_MS      (300)
#define DEFAULT_LAST_HIGH_WATER_MARK_IN_MS      (350)

#define BUFFERING_CHECK_PER_BYTES               (256)
#define BUFFERING_CHECK_PER_MILLISECONDS        (250)

#define MAX_QUEUE_SIZE (1024 * 1024)
#ifdef FFP_MERGE
#define MIN_FRAMES 25
#endif
#define DEFAULT_MIN_FRAMES  50
#define MIN_MIN_FRAMES      9
#define MAX_MIN_FRAMES      50
#define MIN_FRAMES (ffp->dcc.min_frames)
#define EXTERNAL_CLOCK_MIN_FRAMES 3
#define EXTERNAL_CLOCK_MAX_FRAMES 14
