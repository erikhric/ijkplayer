...
public class SurfaceRenderView extends GLSurfaceView implements IRenderView, GLSurfaceView.Renderer {
...
//    }
    ...
    public void onDrawFrame(GL10 gl) {
        currentImage = createBitmapFromGLSurface(0,0,500,500, gl);

        int bitmapBuffer[] = new int[500 * 500];
//        int bitmapSource[] = new int[w * h];
        IntBuffer intBuffer = IntBuffer.wrap(bitmapBuffer);
        intBuffer.position(0);
        gl.glReadPixels(0, 0, 400, 400, GL10.GL_RGBA, GL10.GL_UNSIGNED_BYTE, intBuffer);
        gl.glDrawElements(GLES20.GL_ACTIVE_TEXTURE, 500, GLES20.GL_UNSIGNED_SHORT, intBuffer);
    }
